...
export default function WorkPage() {
  return (
    <div className="mx-auto max-w-6xl px-5 pt-32 pb-24 sm:px-8 sm:pt-40 sm:pb-32">
      <Reveal>
        <span className="text-xs font-medium uppercase tracking-[0.14em] text-text-3">Work</span>
      </Reveal>
      <Reveal delay={0.05}>
      ...
      <Reveal delay={0.1}>
        <p className="mt-6 max-w-2xl text-lg text-text-2 text-pretty">{homepage.workIntro}</p>
      </Reveal>
